...
const Header = () => {
  ...
  const { cartItems } = useSelector((state => state.cart)); // destructuring cart items
      ...
      <Wrapper className="h-[60px] flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 text-black">
          ...
          hover:bg-black/[0.05] cursor-pointer relative">
            ...
            text-[10px] md:text-[12px] flex justify-center items-center
            px-[2px] md:px-[5px]">
              51
            </div>
          </div>
          ...
          hover:bg-black/[0.05] cursor-pointer relative -m-2">
            { mobileMenu ? (
              <VscChromeClose
                className="text-[16px]"
                onClick={ () =>
